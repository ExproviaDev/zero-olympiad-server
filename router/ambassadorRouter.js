...
const { getAllAmbassadors, getReferralList, getAmbassadorSelfStats, updatePromoCode } = require('../controller/ambassadorController');
...
router.put('/update-code', verifyToken, updatePromoCode);
